# Generated by Django 3.1.7 on 2021-08-21 17:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='general_brti_covid_19',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('day_of_week', models.CharField(choices=[('NMRL', 'NMRL'), ('Mpilo', 'Mpilo'), ('BRIDH', 'BRIDH'), ('NTBRL', 'NTBRL'), ('Gweru', 'Gweru'), ('Chinhoyi', 'Chinhoyi'), ('Masvingo', 'Masvingo'), ('eid', 'eid'), ('Victoria Falls', 'Victoria Falls'), ('Bindura', 'Bindura'), ('Kadoma', 'Kadoma'), ('Marondera', 'Marondera'), ('St Lukes', 'St Lukes'), ('Gwanda', 'Gwanda'), ('Total', 'Total')], default='NMRL', max_length=200)),
        ...
        migrations.CreateModel(
            name='machine_downtime_reagent_stockout_tool_brti_covid_19',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('day_of_week', models.CharField(choices=[('NMRL', 'NMRL'), ('Mpilo', 'Mpilo'), ('BRIDH', 'BRIDH'), ('NTBRL', 'NTBRL'), ('Gweru', 'Gweru'), ('Chinhoyi', 'Chinhoyi'), ('Masvingo', 'Masvingo'), ('eid', 'eid'), ('Victoria Falls', 'Victoria Falls'), ('Bindura', 'Bindura'), ('Kadoma', 'Kadoma'), ('Marondera', 'Marondera'), ('St Lukes', 'St Lukes'), ('Gwanda', 'Gwanda'), ('Total', 'Total')], default='NMRL', max_length=200)),
        ...
        migrations.CreateModel(
            name='reasons_for_failure_brti_vl_eid',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('day_of_week', models.CharField(choices=[('NMRL', 'NMRL'), ('Mpilo', 'Mpilo'), ('BRIDH', 'BRIDH'), ('NTBRL', 'NTBRL'), ('Gweru', 'Gweru'), ('Chinhoyi', 'Chinhoyi'), ('Masvingo', 'Masvingo'), ('eid', 'eid'), ('Victoria Falls', 'Victoria Falls'), ('Bindura', 'Bindura'), ('Kadoma', 'Kadoma'), ('Marondera', 'Marondera'), ('St Lukes', 'St Lukes'), ('Gwanda', 'Gwanda'), ('Total', 'Total')], default='NMRL', max_length=200)),
        ...
        migrations.CreateModel(
            name='specimens_received_brti_covid_19',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('day_of_week', models.CharField(choices=[('NMRL', 'NMRL'), ('Mpilo', 'Mpilo'), ('BRIDH', 'BRIDH'), ('NTBRL', 'NTBRL'), ('Gweru', 'Gweru'), ('Chinhoyi', 'Chinhoyi'), ('Masvingo', 'Masvingo'), ('eid', 'eid'), ('Victoria Falls', 'Victoria Falls'), ('Bindura', 'Bindura'), ('Kadoma', 'Kadoma'), ('Marondera', 'Marondera'), ('St Lukes', 'St Lukes'), ('Gwanda', 'Gwanda'), ('Total', 'Total')], default='NMRL', max_length=200)),
        ...
        migrations.CreateModel(
            name='specimens_received_brti_vl_eid',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('day_of_week', models.CharField(choices=[('NMRL', 'NMRL'), ('Mpilo', 'Mpilo'), ('BRIDH', 'BRIDH'), ('NTBRL', 'NTBRL'), ('Gweru', 'Gweru'), ('Chinhoyi', 'Chinhoyi'), ('Masvingo', 'Masvingo'), ('eid', 'eid'), ('Victoria Falls', 'Victoria Falls'), ('Bindura', 'Bindura'), ('Kadoma', 'Kadoma'), ('Marondera', 'Marondera'), ('St Lukes', 'St Lukes'), ('Gwanda', 'Gwanda'), ('Total', 'Total')], default='NMRL', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_results_dispatched_by_lab', models.IntegerField()),
                ('comment', models.CharField(max_length=5000, null=True)),
                ('samples_Referred_to_Name', models.CharField(default='null', max_length=500)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='specimens_run_brti_covid_19',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('day_of_week', models.CharField(choices=[('NMRL', 'NMRL'), ('Mpilo', 'Mpilo'), ('BRIDH', 'BRIDH'), ('NTBRL', 'NTBRL'), ('Gweru', 'Gweru'), ('Chinhoyi', 'Chinhoyi'), ('Masvingo', 'Masvingo'), ('eid', 'eid'), ('Victoria Falls', 'Victoria Falls'), ('Bindura', 'Bindura'), ('Kadoma', 'Kadoma'), ('Marondera', 'Marondera'), ('St Lukes', 'St Lukes'), ('Gwanda', 'Gwanda'), ('Total', 'Total')], default='NMRL', max_length=200)),
        ...
        migrations.CreateModel(
            name='specimens_run_brti_vl_eid',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('day_of_week', models.CharField(choices=[('NMRL', 'NMRL'), ('Mpilo', 'Mpilo'), ('BRIDH', 'BRIDH'), ('NTBRL', 'NTBRL'), ('Gweru', 'Gweru'), ('Chinhoyi', 'Chinhoyi'), ('Masvingo', 'Masvingo'), ('EID', 'EID'), ('Victoria Falls', 'Victoria Falls'), ('Bindura', 'Bindura'), ('Kadoma', 'Kadoma'), ('Marondera', 'Marondera'), ('St Lukes', 'St Lukes'), ('Gwanda', 'Gwanda'), ('Total', 'Total')], default='NMRL', max_length=200)),
        ...
        migrations.CreateModel(
            name='Top_3_brti_vl_weekly',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tat_median_collection_to_pickup_plasma_hrs', models.CharField(max_length=20)),
                ('tat_median_specimen_hub_to_vl_lab_plasma_days', models.CharField(max_length=20)),
                ('tat_median_intra_lab_plasma_days', models.CharField(max_length=20)),
                ('tat_median_results_vl_lab_to_hub_plasma_days', models.CharField(max_length=20)),
                ('tat_median_results_hub_to_clinic_plasma_days', models.CharField(max_length=20)),
                ('tat_median_collection_to_pickup_dbs_hrs', models.CharField(max_length=20)),
                ('tat_median_specimen_hub_to_vl_lab_dbs_days', models.CharField(max_length=20)),
                ('tat_median_intra_lab_dbs_days', models.CharField(max_length=20)),
                ('tat_median_results_vl_lab_to_hub_dbs_days', models.CharField(max_length=20)),
                ('tat_median_results_hub_to_clinic_dbs_days', models.CharField(max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Top_3_brti_weekly',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tat_median_collection_to_pickup_plasma_hrs', models.CharField(max_length=20)),
                ('tat_median_specimen_hub_to_vl_lab_plasma_days', models.CharField(max_length=20)),
        ...
        migrations.CreateModel(
            name='Top_4_brti_vl_weekly',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('machine_number_of_machine_breakdowns_roche', models.CharField(max_length=20)),
                ('machine_number_of_machine_breakdowns_abbott', models.CharField(max_length=20)),
                ('machine_number_of_machine_breakdowns_hologic_panther', models.CharField(max_length=20)),
                ('machine_number_of_machine_breakdowns_bmx', models.CharField(max_length=20)),
                ('machine_reasons_roche', models.CharField(max_length=20)),
                ('machine_reasons_abbott', models.CharField(max_length=20)),
                ('machine_reasons_hologic_panther', models.CharField(max_length=20)),
                ('machine_reasons_bmx', models.CharField(max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Top_4_brti_weekly',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('machine_number_of_machine_breakdowns_roche', models.CharField(max_length=20)),
                ('machine_number_of_machine_breakdowns_abbott', models.CharField(max_length=20)),
        ...
        migrations.CreateModel(
            name='Top_5_brti_vl_weekly',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('machine_downtime_days_roche', models.CharField(max_length=20)),
                ('machine_reasons_roche', models.CharField(max_length=20)),
                ('machine_time_taken_for_downtime_to_be_resolved_roche', models.CharField(max_length=20)),
                ('machine_downtime_days_abbott', models.CharField(max_length=20)),
                ('machine_reasons_abbott', models.CharField(max_length=20)),
                ('machine_time_taken_for_downtime_to_be_resolved_abbott', models.CharField(max_length=20)),
                ('machine_downtime_days_hologic_panther', models.CharField(max_length=20)),
                ('machine_reasons_hologic_panther', models.CharField(max_length=20)),
                ('machine_time_taken_for_downtime_to_be_resolved_hologic_panther', models.CharField(max_length=20)),
                ('machine_downtime_days_bmx', models.CharField(max_length=20)),
                ('machine_reasons_bmx', models.CharField(max_length=20)),
                ('machine_time_taken_for_downtime_to_be_resolved_bmx', models.CharField(max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Top_5_brti_weekly',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('machine_downtime_days_roche', models.CharField(max_length=20)),
                ('machine_reasons_roche', models.CharField(max_length=20)),
        ...
        migrations.CreateModel(
            name='Top_6_1_brti_weekly',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('machine_amount_of_liquid_waste_roche', models.CharField(max_length=20)),
                ('machine_amount_of_liquid_waste_abbott', models.CharField(max_length=20)),
                ('machine_amount_of_liquid_waste_hologic_panther', models.CharField(max_length=20)),
                ('machine_amount_of_liquid_waste_bmx', models.CharField(max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Top_6_brti_vl_weekly',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('machine_stockout_days_roche', models.CharField(max_length=20)),
                ('machine_reasons_roche', models.CharField(max_length=20)),
                ('machine_stockout_days_abbott', models.CharField(max_length=20)),
                ('machine_reasons_abbott', models.CharField(max_length=20)),
                ('machine_stockout_days_hologic_panther', models.CharField(max_length=20)),
                ('machine_reasons_hologic_panther', models.CharField(max_length=20)),
                ('machine_stockout_days_bmx', models.CharField(max_length=20)),
                ('machine_reasons_bmx', models.CharField(max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Top_6_brti_weekly',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('machine_stockout_days_roche', models.CharField(max_length=20)),
                ('machine_reasons_roche', models.CharField(max_length=20)),
        ...
        migrations.CreateModel(
            name='Top_7_brti_vl_weekly',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reagent_tests_loaned_out_to_other_labs_reagent_loaned_to_which_lab_roche', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_reagent_received_on_loan_from_other_labs_roche', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_reagent_received_on_loan_from_which_labs_roche', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_stock_on_hand_roche', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_tests_available_roche', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_months_of_stock_roche', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_tests_expired_this_month_before_use_roche', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_reagent_loaned_to_which_lab_abbott', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_reagent_received_on_loan_from_other_labs_abbott', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_reagent_received_on_loan_from_which_labs_abbott', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_stock_on_hand_abbott', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_tests_available_abbott', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_months_of_stock_abbott', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_tests_expired_this_month_before_use_abbott', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_reagent_loaned_to_which_lab_hologic_panther', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_reagent_received_on_loan_from_other_labs_hologic_panther', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_reagent_received_on_loan_from_which_labs_hologic_panther', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_stock_on_hand_hologic_panther', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_tests_available_hologic_panther', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_months_of_stock_hologic_panther', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_tests_expired_this_month_before_use_hologic_panther', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_reagent_loaned_to_which_lab_bmx', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_reagent_received_on_loan_from_other_labs_bmx', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_reagent_received_on_loan_from_which_labs_bmx', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_stock_on_hand_bmx', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_tests_available_bmx', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_months_of_stock_bmx', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_tests_expired_this_month_before_use_bmx', models.CharField(max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Top_7_brti_weekly',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reagent_tests_loaned_out_to_other_labs_reagent_loaned_to_which_lab_roche', models.CharField(max_length=20)),
                ('reagent_tests_loaned_out_to_other_labs_reagent_received_on_loan_from_other_labs_roche', models.CharField(max_length=20)),
        ...
        migrations.CreateModel(
            name='Top_age_sex_dissagregation_of_all_specimens_received_brti_vl_weekly',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('age_male_less_than_15', models.CharField(max_length=20)),
                ('age_female_non_pbfw_less_than_15', models.CharField(max_length=20)),
                ('age_female_pbfw_less_than_15', models.CharField(max_length=20)),
                ('age_unknown_less_than_15', models.CharField(max_length=20)),
                ('age_total_less_than_15', models.CharField(max_length=20)),
                ('age_male_15_to_19', models.CharField(max_length=20)),
                ('age_female_non_pbfw_15_to_19', models.CharField(max_length=20)),
                ('age_female_pbfw_15_to_19', models.CharField(max_length=20)),
                ('age_unknown_15_to_19', models.CharField(max_length=20)),
                ('age_total_15_to_19', models.CharField(max_length=20)),
                ('age_male_20_to_24', models.CharField(max_length=20)),
                ('age_female_non_pbfw_20_to_24', models.CharField(max_length=20)),
                ('age_female_pbfw_20_to_24', models.CharField(max_length=20)),
                ('age_unknown_20_to_24', models.CharField(max_length=20)),
                ('age_total_20_to_24', models.CharField(max_length=20)),
                ('age_male_25_to_49', models.CharField(max_length=20)),
                ('age_female_non_pbfw_25_to_49', models.CharField(max_length=20)),
                ('age_female_pbfw_25_to_49', models.CharField(max_length=20)),
                ('age_unknown_25_to_49', models.CharField(max_length=20)),
                ('age_total_25_to_49', models.CharField(max_length=20)),
                ('age_male_50_plus', models.CharField(max_length=20)),
                ('age_female_non_pbfw_50_plus', models.CharField(max_length=20)),
                ('age_female_pbfw_50_plus', models.CharField(max_length=20)),
                ('age_unknown_50_plus', models.CharField(max_length=20)),
                ('age_total_50_plus', models.CharField(max_length=20)),
                ('age_male_unknown', models.CharField(max_length=20)),
                ('age_female_non_pbfw_unknown', models.CharField(max_length=20)),
                ('age_female_pbfw_unknown', models.CharField(max_length=20)),
                ('age_unknown_unknown', models.CharField(max_length=20)),
                ('age_total_unknown', models.CharField(max_length=20)),
                ('age_male_totals', models.CharField(max_length=20)),
                ('age_female_non_pbfw_totals', models.CharField(max_length=20)),
                ('age_female_pbfw_totals', models.CharField(max_length=20)),
                ('age_unknown_totals', models.CharField(max_length=20)),
                ('age_total_totals', models.CharField(max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Top_age_sex_dissagregation_of_all_specimens_received_brti_weekly',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('age_male_less_than_15', models.CharField(max_length=20)),
                ('age_female_non_pbfw_less_than_15', models.CharField(max_length=20)),
        ...
        migrations.CreateModel(
            name='Top_age_sex_dissagregation_of_all_specimens_received_covid_19',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='Top_brti_vl_weekly',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reporting_week', models.CharField(max_length=20)),
                ('month', models.CharField(max_length=20)),
                ('laboratory', models.CharField(max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Top_brti_weekly',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reporting_week', models.CharField(max_length=20)),
                ('month', models.CharField(max_length=20)),
